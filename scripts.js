...
function add_book_to_books_list(item){
  if (typeof(item.volumeInfo.imageLinks) == 'undefined') var imageAddress = "Pictures/Brak.png";
  else var imageAddress = item.volumeInfo.imageLinks.thumbnail;
  imageAddress = preventMixedContent(imageAddress);
  document.getElementById("books_list").innerHTML += "<div class = 'book_piece'" +
                                                       ...
                                                       "<br> <div class='book_thumbnail'><img src=" + imageAddress + " alt=" + item.volumeInfo.title + "> </div>" +
...
function load_searching_script(adjusted_search_input)
{
  ...
  var current_request_address = document.getElementById("current_request_address");
  if (current_request_address != null)
  {
  ...
  script.id = "current_request_address";
...
function preventMixedContent(link)
{
